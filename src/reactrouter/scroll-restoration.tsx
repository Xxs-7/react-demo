// link 中将 url 修改 hash 值，和 html 标签的 id 绑定，自动滚动到对应位置
// react-router 会使用 sessionstorage 来缓存滚动位置，当页面刷新时，会自动滚动到上次离开的位置
// 回退自动滚动到位置，而新开 location 时，preventScrollReset 可以保留滚动状态
// scrollrestoration 在跨域返回的时候也能保留滚动位置
          ...
          <div className='fixed'>
            <nav>
              <ul>
                ...
                <li className='navitem'>
                  <Link to='/restore-by-key'>This page restores by location.key</Link>
                </li>
                <li className='navitem'>
                  <Link to='/restore-by-pathname'> This page restores by location.pathname</Link>
                </li>
                <li className='navitem'>
                  <Link to='/link-to-hash#heading'>This link will link to a nested heading via hash</Link>
                </li>
                <li className='navitem'>
                ...
                <li className='navitem'>
                  <a href='https://www.google.com'>This links to an external site (google)</a>
                </li>
              </ul>
            </nav>
          </div>
