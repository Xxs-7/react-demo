...
import Croppers, { CropperProps } from "../Cropper";
// import CircleSVG from "./circle.svg";
// import UploadFailedSVG from "./failed.svg";
// import UploadSVG from "./upload.svg?react";

const IMAGE_UPLOAD_URL = "todo";
...
export function Uploader(props: UploaderProps) {
  ...
  return (
    <div className={className} style={style}>
      ...
      >
        <div ref={uploaderRef}>
          {(src || imgSrc) && showImg ? <img src={src || imgSrc} className={imageClassName} /> : children}
        </div>
      </Upload>
